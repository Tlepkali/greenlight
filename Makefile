...
build/api:
	...
	go build -ldflags='-s -X main.buildTime=${linker_flags}' -o=./bin/api ./cmd/api
	GOOS=linux GOARCH=amd64 go build -ldflags='-s -X main.buildTime=${linker_flags}' -o=./bin/linux_amd64/api ./cmd/api